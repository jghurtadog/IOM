...
const RegistreForm1 = ({setForm}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput style={styles.inputTextBox} placeholder="Correo electrónico" />
      <TextInput style={styles.inputTextBox} placeholder="Contraseña" />
      <TextInput style={styles.inputTextBox} placeholder="Repetir contraseña" />
      <View>
